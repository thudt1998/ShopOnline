...
@section('breadcrumbs')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-9">
            <h2><i class="fa fa-sitemap"></i> Danh sách sản phẩm</h2>
        </div>
        <div class="col-lg-3 btn-add">
            <a href="{{route('product.create')}}" class="btn btn-primary "><i class="fa fa-plus"></i>&nbsp;Thêm
                sản
                phẩm</a>
        </div>
    </div>
                                        ...
                                        <td class="text-right footable-visible footable-last-column">
                                            <div class="btn-group">
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#confirm-delete"
                                                   data-href="{{route('product.delete',$product->id)}}"
                                                   class="btn-white btn btn-xs">
